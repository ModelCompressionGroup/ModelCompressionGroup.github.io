          ...
          <div className="w-full md:w-1/2">
            <div className="relative z-10 text-center md:text-left">
              <h1 style={{ lineHeight: '130%' }} className="text-5xl font-bold leading-tight text-black dark:text-white sm:text-4xl md:text-5xl mb-6">
                <span className="text-primary dark:text-white">AI Model Optimization </span> for Edge Devices.
              </h1>
              ...
              <p className="mb-6 text-sm leading-relaxed text-body-color dark:text-body-color-dark sm:text-lg md:text-xl">
